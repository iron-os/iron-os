...
pub use generated::weston_capture_source_v1::{Event, WestonCaptureSourceV1};
pub use generated::weston_capture_v1::{Source, WestonCaptureV1};
...
mod generated {
	...
	include!(concat!(env!("OUT_DIR"), "/weston_output_capture.rs"));
}
